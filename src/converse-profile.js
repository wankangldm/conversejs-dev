...
converse.plugins.add('converse-profile', {
    ...
    initialize () {
        ...
        _converse.ProfileModal = _converse.BootstrapModal.extend({
            ...
            onFormSubmitted (ev) {
                ...
                const data = {
                    ...
                    'fn': form_data.get('fn'),
                    'orgname':form_data.get('orgname'),
                    'orgunit':form_data.get('orgunit'),
                    'work_number':form_data.get('work_number'),
                    'home_number':form_data.get('home_number'),
            ...
            toHTML () {
                return tpl_chat_status_modal(
                    Object.assign(
                        ...
                        'label_save': __('Save'),
                        'label_xa': __('长时间离开'),
                        'modal_title': __('更改聊天状态'),
                        'placeholder_status_message': __('自定义聊天状态')
                    }));
            },
        ...
        _converse.XMPPStatusView = _converse.VDOMViewWithAvatar.extend({
            ...
            logOut (ev) {
                ev.preventDefault();
                const result = confirm(__("你确定要退出吗?"));
                if (result === true) {
                    _converse.logOut();
                }
            },
