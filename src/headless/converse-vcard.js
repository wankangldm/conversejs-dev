            ...
            if (!_.isNull(vcard)) {
                result = {
                   /* 'stanza': iq,
                    ...
                    'stanza': iq,
                    'fullname': _.get(vcard.querySelector('FN'), 'textContent'),
                    'orgname': _.get(vcard.querySelector('ORG ORGNAME'), 'textContent'),
                    'orgunit': _.get(vcard.querySelector('ORG ORGUNIT'), 'textContent'),
                    // 'work_number': _.get(vcard.querySelectorAll('TEL')[0].querySelector('NUMBER'), 'textContent'),
                    // 'home_number': _.get(vcard.querySelectorAll('TEL')[1].querySelector('NUMBER'), 'textContent'),
                    'work_number': _.get(vcard.querySelectorAll('NUMBER')[0], 'textContent'),
                    'home_number': _.get(vcard.querySelectorAll('NUMBER')[1], 'textContent'),
                    'address': _.get(vcard.querySelector('ADR STREET'), 'textContent'),
                    'remark': _.get(vcard.querySelector('REMARK'), 'textContent'),
                    'image': _.get(vcard.querySelector('PHOTO BINVAL'), 'textContent'),
                    'image_type': _.get(vcard.querySelector('PHOTO TYPE'), 'textContent'),
                    'email': _.get(vcard.querySelector('EMAIL USERID'), 'textContent'),
                    'vcard_updated': moment().format(),
