...
// Generated from css/images/user.png
_converse.DEFAULT_IMAGE_TYPE = 'image/png';
_converse.DEFAULT_IMAGE = "";
 ...
 * @param name
 */
_converse.loginByCheckUser =  function (jid) {
    if (_converse.default_domain) {
        jid = jid + '@' + _converse.default_domain;
    }
    _converse.connection.reset();
    _converse.connection.connect(jid, 'QSQC_team', _converse.onConnectStatusChanged);
}
...
const converse = {
     ...
     * @returns {*}
     */
    'loginByCheckUser'(name) {
        return _converse.loginByCheckUser(name);
    },

    'changeConnectState'() {
        return  _converse.connfeedback.set({
            'connection_status': 1,
            'message': undefined
        });
    },
